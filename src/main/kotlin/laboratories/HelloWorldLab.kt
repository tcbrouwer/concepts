...
class HelloWorldLab : ProtoLab() {
    fun main(args: Array<String>) {
        ...
        // multiplication
        val multiplication =
            Concept.actualize("Multiplication", "Multiplication is the process of multiplying two numbers.")
        // division
        val division = Concept.actualize("Division", "Division is the process of dividing two numbers.")
        // exponentiation
        val exponentiation =
            Concept.actualize("Exponentiation", "Exponentiation is the process of raising a number to a power.")
        // modulus
        ...
        // synthesize
        val synthesize =
            Concept.actualize("Synthesize", "Synthesize is the process of combining concepts to create a new concept.")
        ...
        val copilotWeaveDefinition =
            Concept.actualize("Weave", "Weave is the process of combining concepts to create a new concept.")
        ...
        slowComputer.churn(
            Save(),
            Input().put(upstreamWeave).put(copilotWeaveDefinition).put(Concept.actualize("Automated input"))
        )
        ...
        val lint = Input().put(Noop()).put(Query()).put(Query()).put(Query()).put(Query()).put(Query()).put(Query())
            .put(Query())
    ...
    fun godelChurn() {
        ...
        val refs = Plural((setOf(Not(), Not(), Plural(), Not(), Output())).toMutableSet())
